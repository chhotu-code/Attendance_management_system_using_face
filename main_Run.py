    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'E:/Study/Attendence Management Github file/Attendance Management System using Face Recognition-20241203T115807Z-001/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"E:/Study/Attendence Management Github file/Attendance Management System using Face Recognition-20241203T115807Z-001/Attendance Management System using Face Recognition/Attendance/Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'E:\Study\Attendence Management Github file\Attendance Management System using Face Recognition-20241203T115807Z-001\Attendance Management System using Face Recognition' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"E:\Study\Attendence Management Github file\Attendance Management System using Face Recognition-20241203T115807Z-001\Attendance Management System using Face Recognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'E:\Study\Attendence Management Github file\Attendance Management System using Face Recognition-20241203T115807Z-001\Attendance Management System using Face Recognition\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
